...
{/* prettier-ignore */}
ここまで、 HTML と CSS を勉強してきました。今回は Web 開発で用いられるもう一つの言語、<Term>**JavaScript**</Term> について学びましょう。

<Term>JavaScript</Term> は、Web サイトに動きを与える言語です。ブラウザさえあれば環境に関係なく同じように実行可能な、強力なプログラミング言語です。

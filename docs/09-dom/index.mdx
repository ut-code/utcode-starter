...
<html lang="ja">
  ...
  <body>
    <p id="introduction">こんにちは。私は田中です。</p>
  </body>
</html>
```

JavaScript を使って、`こんにちは。私は田中です。` という部分を `こんにちは。私は鈴木です。` に書き換えてください。

<Answer title="自己紹介の書き換え">
...
<ViewSource url={import.meta.url} path="_samples/change-introduction" />
